...
! function(t, e) {
    ...
    return function(t) {
        ...
        function r(t, e) {
            ...
            var r = n;
            return new r(t instanceof Node ? t : r.create(e), e)
        }
        ...
        S.DEFAULTS = {
            ...
            strict: !0,
            theme: "default"
        }, S.events = g.default.events, S.sources = g.default.sources, S.version = "1.2.3", S.imports = {
            delta: d.default,
            parchment: w.default,
        ...
        s.prototype.insert = function(t, e) {
            ...
            for (var n = l.iterator(this.ops), r = new s, o = 0; n.hasNext();) {
                ...
                if (u < 0) r.push(n.next());
                    ...
                    if (t(r, n.next(1).attributes || {}, o) === !1) return;
                    o += 1, r = new s
                }
            }
            r.length() > 0 && t(r, {}, o)
                ...
                return s(t, [{
                    ...
                    value: function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                if (null != i && null != l) {
                                    var u = this.scroll.scrollingContainer,
                    ...
                    value: function(t) {
                        ...
                        if ("string" == typeof n && (r = n, n = !1), m.info("setRange", t), null != t) {
                            var i = t.collapsed ? [t.index] : [t.index, t.index + t.length],
                                l = [],
        ...
        function h(t) {
            ...
            if ("object" === (void 0 === t ? "undefined" : d(t)) && (t = (0, g.default)(t, !1)), "string" == typeof t.key)
                ...
                toolbar: {
                    handlers: {
                        ...
                        image: function() {
                            ...
                            null == e && (e = document.createElement("input"), e.setAttribute("type", "file"), e.setAttribute("accept", "image/png, image/gif, image/jpeg, image/bmp, image/x-icon, image/svg+xml"), e.classList.add("ql-image"), e.addEventListener("change", function() {
        ...
        _.TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-close"></a>', "</div>"].join(""), e.BubbleTooltip = _, e.default = m
    }, function(t, e, n) {
        "use strict";
        ...
        x.TEMPLATE = ['<a class="ql-preview" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join(""), e.default = w
    }, function(t, e, n) {
        "use strict";
        ...
        function p(t, e, n) {
            return t.nodeType === t.TEXT_NODE ? n.reduce(function(e, n) {
                return n(t, e)
            }, new E.default) : t.nodeType === t.ELEMENT_NODE ? [].reduce.call(t.childNodes || [], function(r, o) {
                var i = p(o, e, n);
                return o.nodeType === t.ELEMENT_NODE && (i = e.reduce(function(t, e) {
                    return e(o, t)
                }, i), i = (o[F] || []).reduce(function(t, e) {
                    return e(o, t)
                }, i)), r.concat(i)
        ...
        function h(t, e, n) {
            return n.compose((new E.default).retain(n.length(), o({}, t, !0)))
        }

        function d(t, e) {
            var n = A.default.Attributor.Attribute.keys(t),
                r = A.default.Attributor.Class.keys(t),
                o = A.default.Attributor.Style.keys(t),
                i = {};
            return n.concat(r).concat(o).forEach(function(e) {
                var n = A.default.query(e, A.default.Scope.ATTRIBUTE);
                null != n && (i[n.attrName] = n.value(t), i[n.attrName]) || (null != K[e] && (n = K[e], i[n.attrName] = n.value(t) || void 0), null != z[e] && (n = z[e], i[n.attrName] = n.value(t) || void 0))
            }), Object.keys(i).length > 0 && (e = e.compose((new E.default).retain(e.length(), i))), e
        }

        function y(t, e) {
            var n = A.default.query(t);
            if (null == n) return e;
            if (n.prototype instanceof A.default.Embed) {
                var r = {},
                    i = n.value(t);
                null != i && (r[n.blotName] = i, e = (new E.default).insert(r, n.formats(t)))
            } else if ("function" == typeof n.formats) {
                var l = o({}, n.blotName, n.formats(t));
                e = e.compose((new E.default).retain(e.length(), l))
            }
            return e
        }
        ...
        function _(t, e) {
            var n = {},
                r = t.style || {};
            return r.fontStyle && "italic" === u(t).fontStyle && (n.italic = !0), r.fontWeight && "bold" === u(t).fontWeight && (n.bold = !0), Object.keys(n).length > 0 && (e = e.compose((new E.default).retain(e.length(), n))), parseFloat(r.textIndent || 0) > 0 && (e = (new E.default).insert("\t").concat(e)), e
        }
        ...
        var w = function() {
            ...
            K = [L.AlignAttribute, I.DirectionAttribute].reduce(function(t, e) {
                return t[e.keyName] = e, t
            }, {}),
            z = [L.AlignStyle, M.BackgroundStyle, R.ColorStyle, I.DirectionStyle, B.FontStyle, D.SizeStyle].reduce(function(t, e) {
                return t[e.keyName] = e, t
            }, {}),
            Z = function(t) {
                function e(t, n) {
                    ...
                    return r.quill.root.addEventListener("paste", r.onPaste.bind(r)), r.container = r.quill.addContainer("ql-clipboard"), r.container.setAttribute("contenteditable", !0), r.container.setAttribute("tabindex", -1), r.matchers = [], H.concat(r.options.matchers).forEach(function(t) {
                ...
                return s(e, t), x(e, [{
                    ...
                    value: function(t) {
                        ...
                        return c(i, "\n") && null == i.ops[i.ops.length - 1].attributes && (i = i.compose((new E.default).retain(i.length() - 1).delete(1))), U.log("convert", this.container.innerHTML, i), this.container.innerHTML = "", i
                    }
                }, {
                    key: "dangerouslyPasteHTML",
                    value: function(t, e) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : q.default.sources.API;
                        if ("string" == typeof t) return this.quill.setContents(this.convert(t), e);
                        var r = this.convert(e);
                        return this.quill.updateContents((new E.default).retain(t).concat(r), n)
                    }
                }, {
                    key: "onPaste",
                    value: function(t) {
                        ...
                        if (!t.defaultPrevented && this.quill.isEnabled()) {
                            var n = this.quill.getSelection(),
                                r = (new E.default).retain(n.index),
                                o = this.quill.scrollingContainer.scrollTop;
                            this.container.focus(), setTimeout(function() {
                                e.quill.selection.update(q.default.sources.SILENT), r = r.concat(e.convert()).delete(n.length), e.quill.updateContents(r, q.default.sources.USER), e.quill.setSelection(r.length() - n.length, q.default.sources.SILENT), e.quill.scrollingContainer.scrollTop = o, e.quill.selection.scrollIntoView()
                            }, 1)
                        }
                    }
                }, {
        ...
        Z.DEFAULTS = {
            matchers: []
        }, e.default = Z, e.matchAttributor = d, e.matchBlot = y, e.matchNewline = g, e.matchSpacing = m, e.matchText = O
    }, function(t, e, n) {
        "use strict";
