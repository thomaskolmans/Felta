        ...
        $(document).ready(function(){
            ...
            $("#user-add").on("submit",function(e){
                ...
                $.ajax({
                  ...
                  success: function(data){
                    ...
                    window.location = window.location.href + "#users";
                  }
                });
                $(this).trigger("reset");
            });
            $("#changepassword").on("submit",function(e){
                ...
                $.ajax({
                  ...
                  success: function(data){
                    ...
                    window.location = window.location.href + "#account";
                  }
                });
                $(this).trigger("reset");
            })
            ...
            $("#general").on("submit",function(e){
              ...
              $.ajax({
                ...
                success: function(){
                  window.location = window.location.href + "#general";
                }
              });
...
<body>
   ...
   <div class="main-wrapper">
    <div class="main settings">
        ...
        <section class="hidden no-padding relative" id="users">
            <a href="#add-user" column="add-user"><button class="add tabs-above">Add user</button></a>
              <?php
        ...
        <section class="hidden" id="add-user">
