...
<head>
   <title>Website currently offline</title>
...
<body>
    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%)">
      <center><img style='height: 25vh; width: 25vh;' src='/felta/images/black.png' /></center>
      <center style='font-size: 6vh; font-weight: 100'><h1>Website is currently offline</h1></center>
    </div>
</body>
</html>