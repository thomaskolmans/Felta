  ...
  <div class="main dashboard">
   ...
   <section class="hub">
     ...
     <div class="live">
      ...
      <div class="status offline" id="website_is">Your website is <status id="website_status">offline</status></div>
   </section>
   ...
   <div class="stats head">
      ...
      <table>
       ...
       <tr>
          ...
          ?>
          <th>Unique users</th>
          <td><?php echo $sql->execute("select count(*) from visitors_unqiue where date >= curdate()")[0][0]; ?></td>
          <td><?php echo $sql->execute("select count(*) from visitors_unqiue where yearweek(date) = yearweek(curdate())")[0][0]; ?></td>
          <td><?php echo $sql->execute("select count(*) from visitors_unqiue where year(date) = year(curdate()) and month(date) = month(curdate())")[0][0]; ?></td>
          <td><?php echo $sql->execute("select count(*) from visitors_unqiue where year(date) = year(curdate())")[0][0]; ?></td>
       </tr>
       <tr>
          <th>Sessions </th>
          <td><?php echo $sql->execute("select count(*) from visitors_total where date >= curdate()")[0][0]; ?></td>
          <td><?php echo $sql->execute("select count(*) from visitors_total where yearweek(date) = yearweek(curdate())")[0][0]; ?></td>
          <td><?php echo $sql->execute("select count(*) from visitors_total where year(date) = year(curdate()) and month(date) = month(curdate())")[0][0]; ?></td>
          <td><?php echo $sql->execute("select count(*) from visitors_total where year(date) = year(curdate())")[0][0]; ?></td>
        </tr>
     </table>
   </div>
     <div class="thankyou">
