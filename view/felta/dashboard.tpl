   ...
   <section class="full stats">
      ...
      <table>
       ...
       <tr>
          ...
          ?>
          <th>Unique users</th>
          <td><?php echo $sql->execute("select count(*) from visitors_unique where date >= curdate()")[0][0]; ?></td>
          <td><?php echo $sql->execute("select count(*) from visitors_unique where yearweek(date) = yearweek(curdate())")[0][0]; ?></td>
          <td><?php echo $sql->execute("select count(*) from visitors_unique where year(date) = year(curdate()) and month(date) = month(curdate())")[0][0]; ?></td>
          <td><?php echo $sql->execute("select count(*) from visitors_unique where year(date) = year(curdate())")[0][0]; ?></td>
       </tr>
       <tr>
          <th>Sessions </th>
